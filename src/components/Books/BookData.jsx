export const BookData = [
  {
    ...
    bookTypes: [
      ...
      {
        path: "books/order-of-the-phoenix",
        writer: "J.K. Rowling",
      ...
      {
        path: "books/the-half-blood-prince",
        writer: "J.K. Rowling",
      ...
      {
        path: "books/the-deadthly-hallows",
        writer: "J.K. Rowling",
  ...
  },
  {
    ...
    bookTypes: [
      {
        path: "books/fantastic-beasts-and-where-to-find-them",
        writer: "J.K. Rowling",
      ...
      {
        path: "books/fantastic-beasts-the-crimes-of-grindelwald",
        writer: "J.K. Rowling",
      ...
      {
        path: "books/fantastic-beasts-the-sercrets-of-dumbi",
        writer: "J.K. Rowling",
  ...
  {
    type: "Hogwarts Library",
    bookTypes: [
      {
        path: "books/fantastic-beasts-and where-to-find-them-schoolbook",
        writer: "J.K. Rowling",
        title: "Fantastic Beasts and Where to Find Them",
        year: 2001,
        image: "src/images/hp1.jpg",
